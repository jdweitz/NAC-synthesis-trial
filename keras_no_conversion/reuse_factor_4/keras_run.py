...
config['Model']['ReuseFactor'] = 4 # changed from 8 to 4, incomplete synthesis with 8
...
hls_model = hls4ml.converters.convert_from_keras_model(
    ...
    hls_config=config,
    output_dir='synthesis_reuse4/hls4ml_prj',
...
# Check the reports
hls4ml.report.read_vivado_report('synthesis_reuse4/hls4ml_prj/')
